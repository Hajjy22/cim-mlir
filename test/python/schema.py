...
CANONICAL_ORDER = [
    ...
    "costs.reduce_partial.latency_ns",
    "costs.reduce_partial.energy_pj",
    "costs.reduce_max.latency_ns",
    "costs.reduce_max.energy_pj",
    ...
    costs = draw(_entries(
        required=[
            ...
            ("requantize", [("latency_ns", draw(_doubles)),
                            ("energy_pj", draw(_doubles))]),
            ("reduce_partial", [("latency_ns", draw(_doubles)),
                                ("energy_pj", draw(_doubles))]),
            ("reduce_max", [("latency_ns", draw(_doubles)),
                           ("energy_pj", draw(_doubles))]),
